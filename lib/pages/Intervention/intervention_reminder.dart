...
class InterventionRemind extends StatefulWidget {
  @override
  _InterventionRemindState createState() => _InterventionRemindState();
...
class _InterventionRemindState extends State<InterventionRemind> {
  @override
  Widget build(BuildContext context) {
    final InterventionArgs? args = context.getRouteArguments();
    final questions = args?.interventionQuestions?.interventionReminderQuestions ?? [];
            ...
            children: [
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (_, index) => Padding(
                      ...
                      child: QuestionWidget(
                        ...
                        //   final index = args?.interventionReminderAnswer?.indexWhere((element) => element.questionID == answer?.questionID) ?? -1;
                        //   if (index >= 0 && answer != null) {
                        //     args?.interventionReminderAnswer?[index] = answer;
                        //   }
                        //   setState(() {});
                        // },
                      ),
              ...
              TextButton(
                  ...
                  onPressed: () {
                    ...
                    // if (_validateAnswers(args?.interventionReminderAnswer)) {
                    //   context.read<InterventionCubit>().submitAnswers();
                    // }
                  }),
